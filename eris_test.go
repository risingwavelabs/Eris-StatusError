...
func TestRootWrapping(t *testing.T) {
	...
	// test unpack root
	gotUnpackRootMsg := unpacked.ErrRoot.Msg
	...
	tmp, _ := json.Marshal(eris.ToJSON(wrappedErr, false))
	gotJson := string(tmp)
